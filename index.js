...
const clearScreen=()=>{
    ...
    context.fillStyle = "rgb(31,29,30)"
...
const highestScore=()=>{
    let localHostScore = localStorage.getItem('highScore')
    if(localHostScore==null){
        localHostScore=score
        localStorage.setItem('highScore',localHostScore)
    }
